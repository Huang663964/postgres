...
PG_KEYWORD("branch", BRANCH, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("breadth", BREADTH, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("buffer", BUFFER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("materialize", MATERIALIZE, UNRESERVED_KEYWORD, BARE_LABEL)
